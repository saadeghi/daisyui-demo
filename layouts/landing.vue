<template>
  ...
  >
    <div
      class="sticky inset-x-0 top-0 z-50 w-full shadow-sm bg-base-100 text-base-content"
    >
      <div class="mx-auto max-w-7xl navbar">
        <div class="flex items-center flex-1">
          <NuxtLink to="/" class="px-2 flex-0 btn btn-ghost md:px-4">
            <div class="inline-block w-20" v-html="svgLogo"></div>
          </NuxtLink>
          <span class="px-1 font-mono text-xs text-opacity-50 text-base-content"><span class="hidden lg:inline">version</span> {{ DAISYUI_VERSION }}</span>
        </div>

        <div class="items-center flex-none">
          <a target="_blank" href="https://github.com/saadeghi/daisyui" class="btn btn-ghost drawer-button">
            <svg
              width="24"
              height="24"
              fill="currentColor"
              class="md:mr-2 text-base-content"
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <span class="hidden normal-case md:inline">Github</span>
          </a>
        </div>

        <div class="flex-none" title="Change Theme">
          <label class="relative overflow-hidden btn btn-ghost">
            <svg
            ...
            <span class="hidden normal-case md:inline">Change Theme</span>
          </label>
        </div>
