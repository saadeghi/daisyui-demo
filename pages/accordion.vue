<template>
  <div>
    <Wrapper title="accordion" classes="flex flex-col space-y-2">
      <Accordion>
        <AccordionItem
        ...
        >
          <p>
            ...
            mollitia quos assumenda non. Iusto rerum doloribus. Architecto
            dolorum explicabo omnis quidem. Quibusdam ipsam beatae soluta et
            dolores iure ut debitis ad.
          </p>
        </AccordionItem>
        <AccordionItem
          classes="text-xl font-medium accordion-title"
