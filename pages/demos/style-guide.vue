<template>
  <div>
    ...
    <div class="pt-32 pb-12">
      <div class="inline-block font-bold border-b-8 text-7xl text-content-900 border-primary">Typography</div>
    </div>

    <div class="flex space-x-6">
      <div class="space-y-2 font-bold text-content-900">
        <div class="text-9xl">AaBbCc</div>
        <div class="text-8xl">AaBbCc</div>
        <div class="text-7xl">AaBbCc</div>
        <div class="text-6xl">AaBbCc</div>
        <div class="text-5xl">AaBbCc</div>
        <div class="text-4xl">AaBbCc</div>
        <div class="text-3xl">AaBbCc</div>
        <div class="text-2xl">AaBbCc</div>
        <div class="text-xl">AaBbCc</div>
        <div class="text-lg">AaBbCc</div>
        <div class="text-base">AaBbCc</div>
        <div class="text-sm">AaBbCc</div>
        <div class="text-xs">AaBbCc</div>
      </div>
    ...
    <div class="pt-32 pb-12">
      <div class="inline-block font-bold border-b-8 text-7xl text-content-900 border-primary">Brand Colors</div>
    </div>

    <div class="grid grid-cols-4 gap-6 mt-10 text-xs font-semibold capitalize text-content-400">
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-primary-lighten"></div>
        <div class="py-4">primary lighten</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-primary"></div>
        <div class="py-4">primary</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-primary-darken"></div>
    ...
    <div class="grid grid-cols-4 gap-6 mt-10 text-xs font-semibold capitalize text-content-400">
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-secondary-lighten"></div>
        <div class="py-4">secondary lighten</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-secondary"></div>
        <div class="py-4">secondary</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-secondary-darken"></div>
    ...
    <div class="grid grid-cols-4 gap-6 mt-10 text-xs font-semibold capitalize text-content-400">
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-accent-lighten"></div>
        <div class="py-4">accent lighten</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-accent"></div>
        <div class="py-4">accent</div>
      </div>
      <div>
        <div class="shadow-lg w-52 h-52 rounded-box bg-accent-darken"></div>
        <div class="py-4">accent darken</div>
      </div>
    </div>

    <div class="pt-32 pb-12">
      <div class="inline-block font-bold border-b-8 text-7xl text-content-900 border-primary">Content Colors</div>
    </div>

    <div class="grid grid-cols-5 gap-6 mt-10 text-xs font-semibold capitalize text-content-400">
      <div>
    ...
    <div class="pt-32 pb-12">
      <div class="inline-block font-bold border-b-8 text-7xl text-content-900 border-primary">State Colors</div>
    </div>
